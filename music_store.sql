...
SELECT customers.customer_id, first_name, last_name, SUM(total) AS total_spending
FROM customers
...
WITH RECURSIVE
	sales_per_country AS(
		SELECT COUNT(*) AS purchases_per_genre, customers.country, genre.name, genre.genre_id
		FROM invoice_line
		JOIN invoice ON invoice.invoice_id = invoice_line.invoice_id
		JOIN customers ON customers.customer_id = invoice.customer_id
		JOIN track ON track.track_id = invoice_line.track_id
